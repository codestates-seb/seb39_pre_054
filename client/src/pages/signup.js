        ...
        <Signupdiv className="content">
          <Signupdiv className="center">
            <Signupdiv className="body1">
              ...
              <Body1div>
                <Body1img
                  src={process.env.PUBLIC_URL + "/img/join1.png"}
                ></Body1img>
                <div>Get unstuck — ask a question</div>
              </Body1div>
              <Body1div>
                <Body1img
                  src={process.env.PUBLIC_URL + "/img/join2.png"}
                ></Body1img>
                <div>Unlock new privileges like voting and commenting</div>
              </Body1div>
              <Body1div>
                <Body1img
                  src={process.env.PUBLIC_URL + "/img/join3.png"}
                ></Body1img>
                <div>Save your favorite tags, filters, and jobs</div>
              </Body1div>
              <Body1div>
                <Body1img
                  src={process.env.PUBLIC_URL + "/img/join4.png"}
                ></Body1img>
            ...
            <Signupdiv className="body2">
              <Signupdiv className="button2">
                <GoogleButton>
                  <LogoImage
                    src={process.env.PUBLIC_URL + "/img/googleimage.png"}
                  ></LogoImage>
                  Sign up with Google
                </GoogleButton>
                <GitHubButton>
                  <LogoImage src={GithubIcon}></LogoImage>Sign up with GitHub
                </GitHubButton>
                <FacebookButton>
                  <LogoImage src={FacebookIcon}></LogoImage>Sign up with
                  Facebook
                </FacebookButton>
              </Signupdiv>
              <div className="form_container">
                <form id="login-form">
                  <Inputdiv>
                    ...
                    <ErrorP style={nonameError} className="errormsg">
                  ...
                  <Inputdiv>
                    ...
                    ></InputText>
                    <ErrorP style={emailError} className="errormsg">
                      Please check email
                    </ErrorP>
                    <ErrorP style={noemailError} className="errormsg">
                  ...
                  <Inputdiv>
                    ...
                    <ErrorP style={nopasswordError} className="errormsg">
